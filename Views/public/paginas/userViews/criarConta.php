...
Não foi possível registrar sua conta, pois houve um erro: <br>
<?php echo $fail; ?>
...
<div class="container flexColumn w100" style="height:70%;margin-top:1%; overflow-y:auto; overflow-x:hidden; flex-wrap: nowrap;">
    ...
    <form action="<?php echo routes::HOME_PATH . 'user/criarConta'; ?>" method="post" class="flexColumn w100" style="justify-content:space-between">
